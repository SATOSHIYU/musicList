...
class musicListTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        title = searchText.artist

        if let urlStr = "https://itunes.apple.com/search?term=\(searchText.artist)&media=music&country=\(searchText.country)".addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed), let url = URL(string: urlStr) {
            print(urlStr)
